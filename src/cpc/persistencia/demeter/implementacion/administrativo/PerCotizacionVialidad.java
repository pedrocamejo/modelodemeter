...
public class PerCotizacionVialidad extends DaoGenerico<CotizacionVialidad, Integer>{

	


	public PerCotizacionVialidad() {
		super(CotizacionVialidad.class);
	}
	
	public void guardar(CotizacionVialidad objeto,  ControlSede sede)  throws Exception, SQLException {
	...
	public void nuevo(CotizacionVialidad docu, ControlSede control)  throws ExcFiltroExcepcion, SQLException {
		docu.setEstadoExoneracion(new PerEstadoExoneracionContrato().getNoExonerado());
		Transaction tx = null;
		Session em ;
		try{		
			docu.setSerie(control.getProximaSerieCotizacionVialidad());
			docu.setNroControl(control.getControlCotizacionVialidad());	
	...
	public Cotizacion getDetalle(CotizacionVialidad entrada){
