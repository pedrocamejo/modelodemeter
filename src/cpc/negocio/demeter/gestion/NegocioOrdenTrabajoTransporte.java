...
public class NegocioOrdenTrabajoTransporte extends NegocioGenerico<OrdenTrabajoTransporte, PerOrdenTrabajoTransporte, Long> {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4313150339055514965L;
	private static NegocioOrdenTrabajoTransporte negocio;
	
	private  NegocioOrdenTrabajoTransporte(){
		setPersistencia(new PerOrdenTrabajoTransporte());
	}

	public  static synchronized NegocioOrdenTrabajoTransporte getInstance() {
		if (negocio == null)
			negocio = new NegocioOrdenTrabajoTransporte();
		return negocio;
	}
	...
	public void guardar(OrdenTrabajoTransporte ordenTrabajoTransporte) throws Exception
	{	
		ordenTrabajoTransporte.setSede(getSede());
		new PerOrdenTrabajoTransporte().guardarOrden(ordenTrabajoTransporte, ordenTrabajoTransporte.getId());
	}
	
	public void anular(OrdenTrabajoTransporte ordenTrabajoTransporte) throws ExcFiltroExcepcion
	{
		new PerOrdenTrabajoTransporte().anular(ordenTrabajoTransporte, ordenTrabajoTransporte.getId(), false);
	}
	public void cerrar(OrdenTrabajoTransporte ordenTrabajoTransporte) throws ExcFiltroExcepcion
	{
		new PerOrdenTrabajoTransporte().cerrar(ordenTrabajoTransporte, ordenTrabajoTransporte.getId());
	}
	...
	public OrdenTrabajoTransporte inizializar(OrdenTrabajoTransporte orden) {
		...
		return new PerOrdenTrabajoTransporte().inizializar(orden);
	}
}
