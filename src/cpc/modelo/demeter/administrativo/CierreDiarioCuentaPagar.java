...
import cva.pc.demeter.utilidades.Formateador;
 ...
 @Audited @Entity
@Table(name="tbl_dem_cierrediariocuentapaga", schema="administracion")
public class CierreDiarioCuentaPagar implements Serializable{
	...
	@SequenceGenerator(name="SeqCierrePago", sequenceName="administracion.tbl_dem_cierrediariocuentapaga_seq_idcierrecuenta_seq", allocationSize=1)
	@Id @GeneratedValue(generator="SeqCierrePago")
	...
	@Transient
	public String getStrPagar() {
		return  Formateador.formatearMoneda(getPagar());
	}
	
	
	@Transient
	public String getStrPagada() {
		return  Formateador.formatearMoneda(getPagada());
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof CierreDiarioCuentaPagar)) {
			return false;
		}
		CierreDiarioCuentaPagar other = (CierreDiarioCuentaPagar) o;
